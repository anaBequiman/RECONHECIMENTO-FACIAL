//https://teachablemachine.withgoogle.com/models/vYptg1WYO/
Webcam.set({
    width:400,
    height:300,
    image_format:'png',
...
classificador = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/vYptg1WYO/model.json', classificadordeImgens);
...
function pegarResultado(erro, resultado){
    ...
    if (erro){
        ...
        document.getElementById("pss").innerHTML = resultado[0].label ;
